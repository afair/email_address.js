var defaults = {
  ...
  dnsLookup:         "mx",  // :mx, :a, :off
  sha1Secret:        "",
  mungeString:       "*****",

  localLowercase:    true,
  localFix:          false,
  localEncoding:     "ascii", // :ascii, :unicode,
  localParse:        undefined,   // nil, Proc
  localFormat:       "conventional", // :conventional, :relaxed, :redacted, :standard, Proc
  localSize:         [1,64],
  tagSeparator:      '+', // nil, character
  mailboxSize:       [1,64], // without tag
  mailboxCanonical:  undefined, // nil,  Proc
  mailboxValidator:  undefined, // nil,  Proc
  ...
  addressSize:       [3,254],
  addressFqdnDomain: undefined, // Fully Qualified Domain Name = [host].[domain.tld]
